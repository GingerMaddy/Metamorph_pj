...
function set_up_connection($host, $dbname, $username, $password) {
  ...
  try {
        ...
        /**
         * PDO è un oggetto che salva dentro di sè i dati per connettersi
         * (in questo caso quelli della funzione precedente per accesso). 
         * Gli oggetti sono un modo diverso di categorizzazione di dati, in questo caso la definizione del dB.
         * si associano funzioni e dati, quindi a seconda della catgorizzazione 
         * la funzione con dati diversi fa le stesse cose
         */
        return $pdo;
